...
Tags:buddypress, block, users, ignore
...
Let your BuddyPress users block other members from contacting them or viewing their profile.
...
1. Upload `buddypress-block` to the `/wp-content/plugins/` directory
...
Yes. Add `define( 'BPB_ADMIN_CAP', 'capability' );` to your themes functions.php file.
...
= 1.0Beta5 =
* Added proper filtering of the activities feed removing those we block and those who block us
* Added BPB_ADMIN_CAP constant to set which capability to exclude from being able to get blocked by members
...
* Moved assets into correct directory and removed from plugin (Thanks bp-help)
* Removed index.php files (Thanks bp-help)
